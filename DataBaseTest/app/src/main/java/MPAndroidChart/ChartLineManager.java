...
public class ChartLineManager {
    private LineChart lineChart;  //折线
    private YAxis leftAxis;       //左Y轴
    private YAxis rightAxis;      //右Y轴
    private XAxis xAxis;          //X轴
    private LineData lineData;    //数据
    private LineDataSet lineDataSet;
    private List<ILineDataSet> lineDataSets = new ArrayList<>();    //lineDataSet集合
    private SimpleDateFormat df = new SimpleDateFormat("HH:mm:ss");//设置日期格式
    private List<String> timeList = new ArrayList<>(); //存储x轴的时间
    //一条曲线
    public ChartLineManager(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public ChartLineManager(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
